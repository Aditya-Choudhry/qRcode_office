...
const KeywordSection = () => {
  ...
  const fetchKeywords = async () => {
    ...
    try {
      const response = await axios.get('https://crm.qrps.ca:5000/apii/keywords', {
        params: {
          businessId
        }
      });
  ...
  const addKeyword = async (keyword, language) => {
    ...
    try {
      const response = await axios.post('https://crm.qrps.ca:5000/apii/keywords', {
        keyword,
        language,
        businessId,
        ownerId
  ...
  const deleteKeyword = async (id) => {
    try {
      ...
      await axios.delete(`https://crm.qrps.ca:5000/apii/keywords/${id}`);
  ...
  const editKeyword = async (id, newKeyword, newLanguage) => {
    try {
      ...
      const response = await axios.put(`https://crm.qrps.ca:5000/apii/keywords/${id}`, {
        keyword: newKeyword,
