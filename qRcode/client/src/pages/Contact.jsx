...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('https://crm.qrps.ca:5000/api/contact', formData);
    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div>
            <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Subject</label>
            <input
              type="text"
              name="username"
              id="username"
